    ...
    return (
        <div>
            ...
            <div className="mb-6 sm:mb-8">
                <Link
                    href="/account/orders"
                    className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-black dark:hover:text-white transition-colors mb-4 py-1 min-h-[44px]"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        <h2 className="font-bold uppercase tracking-wide border-b border-gray-100 dark:border-gray-800 pb-2 text-sm">
                            Items
                        </h2>
                        {[1, 2].map((i) => (
                            <div key={i} className="flex gap-3 sm:gap-4">
                                <div className="w-16 h-20 sm:w-20 sm:h-24 bg-gray-100 dark:bg-gray-800 rounded-lg flex-shrink-0" />
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start gap-2">
                                        <div className="min-w-0">
                                            <h3 className="font-bold text-sm uppercase truncate">Classic White Tee</h3>
                                            <p className="text-xs text-gray-500 mt-1">Size: M | Color: White</p>
                                        </div>
                                        <p className="font-bold text-sm flex-shrink-0">$45.00</p>
                                    </div>
                    ...
                    <div className="space-y-6 border-t border-gray-100 dark:border-gray-800 pt-8">
                        <h2 className="font-bold uppercase tracking-wide border-b border-gray-100 dark:border-gray-800 pb-2 mb-4 text-sm">
                            Tracking
                        </h2>

                        <div className="space-y-6 sm:space-y-8 pl-2 border-l-2 border-gray-100 dark:border-gray-800 ml-2">
                            <div className="relative pl-6 sm:pl-8">
                                <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-green-500 border-2 border-white dark:border-black" />
                            ...
                            <div className="relative pl-6 sm:pl-8 opacity-50">
                                <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-gray-300 dark:bg-gray-700 border-2 border-white dark:border-black" />
                ...
                <div className="space-y-6 sm:space-y-8">
                    <div className="bg-gray-50 dark:bg-gray-900 p-5 sm:p-6 rounded-lg">
                    ...
                    <button className="w-full border border-gray-200 dark:border-gray-800 py-3 text-sm font-bold uppercase tracking-wider hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors rounded-lg min-h-[44px]">
